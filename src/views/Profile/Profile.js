...
import {fetchProfileRequest} from "../../epics-reducers/services/fetch-profile.duck";
import {fetchLoginSuccess} from "../../epics-reducers/services/fetch-login.duck";
...
class Profile extends Component {
  ...
  componentDidMount() {
    this.props.dispatch(fetchProfileRequest({
      data: {username: this.props.loginRes.user.username},
      method: CONSTANTS.GET
    }))
  }

  componentDidUpdate(prevProps) {
    if (this.props.profileRes !== prevProps.profileRes) {
      this.setState({userProfile: this.props.profileRes.user})
      this.props.dispatch(fetchLoginSuccess(this.props.profileRes))
    }
  }
  ...
  handleElement(event) {
    this.state.userProfile[event.target.id] = event.target.value
              ...
              <CardBody>
                <Form action="" method="post" className="form-horizontal">
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="username" name="hf-username" placeholder="Enter username..."
                             value={this.state.userProfile.username || null}
                             disabled/>
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="full_name" name="full_name" placeholder="Enter full name..."
                             value={this.state.userProfile.full_name || null}
                             onChange={this.handleElement.bind(this)}/>
                      <FormText className="help-block">Please enter your full name</FormText>
                    </Col>
                  </FormGroup>
                </Form>
              </CardBody>
              <CardFooter>
                <Button type="reset" size="sm" color="danger" onClick={this.handleGoBack.bind(this)}><i
                  className="fa fa-ban"></i> Back</Button>
                &nbsp;
                <Button type="submit" size="sm" color="primary" onClick={this.handleUpdateProfile.bind(this)}><i
                ...
                <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                  ...
                  <FormGroup row>
                    ...
                    <Col md="9">
                      ...
                      <FormGroup check inline>
                        <Input className="form-check-input" type="radio" id="inline-radio3" name="inline-radios"
                               value="option3"/>
                  ...
                  <FormGroup row>
                    ...
                    <Col md="9">
                      ...
                      <FormGroup check inline>
                        <Input className="form-check-input" type="checkbox" id="inline-checkbox2"
                               name="inline-checkbox2" value="option2"/>
                        <Label className="form-check-label" check htmlFor="inline-checkbox2">Two</Label>
                      </FormGroup>
                      <FormGroup check inline>
                        <Input className="form-check-input" type="checkbox" id="inline-checkbox3"
              ...
              <CardBody>
                <Form action="" method="post" className="form-horizontal">
                  <FormGroup row>
                    ...
                    <Col sm="6">
                      <Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
                  ...
                  <FormGroup row>
                    ...
                    <Col sm="6">
                      <Input bsSize="lg" type="text" id="input-large" name="input-large" className="input-lg"
              ...
              <Card>
                <CardHeader>
                  ...
                  <div className="card-header-actions">
                    ...
                    <Button color="link" className="card-header-action btn-close" onClick={this.toggleFade}><i
